...
def choose_correct_head_mask(args, final_scores):
    """
    This method backtracks and finds the correct mask to output at the end of the pruning stage.
    :param args: Args parser containing arguments.
    :type args: argparse
    :param final_scores: Array containing the final scores
    :type final_scores: nd.array
    :return: head mask and model number
    :rtype: tuple
    """
